		...
		<div class="footer__cont">
			<!-- <div class="container"> -->
				<div class="row align-items-center justify-content-center">
					<div class="col-lg my-5 order-1 big f900">Coca Cola zbliża<br>nas do siebie</div>
					<div class="col-lg order-0 order-lg-2 footer__logo align-self-start">
						<img src="<?php echo get_template_directory_uri(); ?>/assets/img/bg/footer_logo.png" alt="">
					</div>
					<div class="col-lg my-5 order-3 f900">
						<span class="big">Dołącz na nasz serwer</span><br>
						żeby być na bieżąco!
						<div class="dc">
				...
				<div class="row">
					<div class="col-12">
						<div class="footer__low footer__copy">&copy;2021 The Coca-Cola Company</div>
					</div>
				</div><!-- /.row -->
			<!-- </div>/.container -->
		</div>
